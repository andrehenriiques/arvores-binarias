...
public class ArvoreBinaria {
    ...
    public void localizar(int valor) {
        if (this.raiz == null) {
            System.out.println("Arvore Vazia");
        }  if (localizar(this.raiz, valor) == true) {
    ...
    public void MaiorValor (){
		...
		System.out.println("Maior: " + MaiorValor(raiz).getValor());
		}
	}
    ...
    public void MenorValor (){
		...
		System.out.println("Menor: " + MenorValor(raiz).getValor());
		}
	}
    ...
    public void SomarNos(){
		if (SomarNos(raiz) == 0){
			...
			System.out.println("Soma:" + SomarNos(raiz));
		}
	}
    ...
    public void MediaNos (){
		...
		int media = SomarNos(raiz)/getQtNo(raiz);
    ...
    public void imprimirArvorePreOrdem() {
        if (this.raiz == null) {
            ...
            imprimirArvorePreOrdem(this.raiz);
        }
    }
    ...
    public void imprimirArvorePosOrdem() {
        if (this.raiz == null) {
            ...
            imprimirArvorePosOrdem(this.raiz);
        }
    }
    ...
    public void GrauNo (int valor){
        if (this.raiz == null){
            ...
            System.out.println("O grau do nome é: " + GrauNo(this.raiz, valor));
        }
    }
    ...
    public void NiveldoNo (int valor){
        if (this.raiz == null){
            ...
            System.out.println("O nivel do no é: " + NiveldoNo(this.raiz, valor));
        }
    }
    ...
    public void SomarPar (){
        if (this.raiz == null){
            ...
            System.out.println("A soma dos numeros pares: " + SomarPar(this.raiz));
        }
    }
    ...
    public void SomarImpar (){
        if (this.raiz == null){
            ...
            System.out.println("A soma dos numeros impares: " + SomarImpar(this.raiz));
        }
    }
    ...
    public void ProcurarPai(int valor){
        if (this.raiz == null){
            ...
            System.out.println("O pai do valor é: " + ProcurarPai(raiz, valor));
        }
    }
    ...
    public void QuantidadeNosComDoisFilhos(){
        if (this.raiz == null){
            ...
            System.out.println("Quantidade de nos com 2 filhos: " + QuantidadeNosComDoisFilhos(raiz));
        }
    }
    ...
    public void GrauArvore(){
        if (this.raiz == null){
            ...
            System.out.println("O grau da arvore e: "+GrauArvore(raiz));
        }
    }
...
/*    public int ImprimirNoDoisFilho (No no){
    ...
    public No CandidatoPai(No no, int valor) {
		if (this.raiz == null) {
			System.out.println("Arvore vazia");
		} else if (valor == raiz.getValor() && raiz.getNoEsquerdo()== null && raiz.getNoDireita()== null) {
    ...
    public void RemoverNoUmfilho(int valor){
        if (this.raiz == null){
            ...
            if(RemoverNoUmFilho(raiz,valor)== true){
    ...
    public void RemoverNoDoisfilhos(int valor){
        if (this.raiz == null){
            ...
            if(RemoverNoDoisFilhos(raiz,valor)== true){
